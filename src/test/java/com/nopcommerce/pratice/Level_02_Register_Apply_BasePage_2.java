...
//
//public class Level_02_Register_Apply_BasePage_2 {
//	WebDriver driver;
...
//		
//		basePage.sendkeyToElement(driver, "//input[@id='FirstName']", "Geni");
//		basePage.sendkeyToElement(driver, "//input[@id='LastName']", "Nguyen");
//		basePage.sendkeyToElement(driver, "//input[@id='Email']", "asdb12#@123");
...
//		basePage.clickToElement(driver, "//button[@id='register-button']");
//		
//        Assert.assertEquals(basePage.getElementText(driver, "//div[contains(@class, 'message-error')]"), "Wrong email");
//	}
//	
//	@Test
