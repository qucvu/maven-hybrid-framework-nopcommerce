...
public class RegisterPageUI {
	...
	public static final String CONFIRM_PASSOWORD_ERROR_MESSAGE = "xpath=//span[@id='ConfirmPassword-error']";
	...
	public static final String WRONG_EMAIL_ERROR_MESSAGE = "xpath=//div[contains(@class, 'message-error')]";
