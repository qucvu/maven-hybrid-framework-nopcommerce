...
public class BasePage {
    ...
    public void hoverToShoppingCartLinkAtUserPage(WebDriver driver) {
        waitForElementClickable(driver, BasePageNopCommerceUI.SHOPPING_CART_LINK_USER_PAGE);
        hoverMouseToElement(driver, BasePageNopCommerceUI.SHOPPING_CART_LINK_USER_PAGE);
    }

    public void enterToSearchStoreTextBox(WebDriver driver, String value) {
        waitForElementVisibility(driver, BasePageNopCommerceUI.SEARCH_STORE_TEXTBOX);
        sendkeyToElement(driver, BasePageNopCommerceUI.SEARCH_STORE_TEXTBOX, value);
    }

    public void clickToSearchStoreButton(WebDriver driver) {
        waitForElementClickable(driver, BasePageNopCommerceUI.SEARCH_STORE_BUTTON);
        clickToElement(driver, BasePageNopCommerceUI.SEARCH_STORE_BUTTON);
    }
